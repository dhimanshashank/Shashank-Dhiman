const NetflixFooter = () => {
  const footerLinks = {
    'Company': ['About Us', 'Jobs', 'Press', 'Investor Relations'],
    'Support': ['Contact Us', 'Help Center', 'Accessibility', 'Account'],
    'Legal': ['Privacy Policy', 'Terms of Use', 'Cookie Preferences', 'Legal Notices'],
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-500 text-sm mb-4 md:mb-0">
              © 2024 Shashank Portfolio. All rights reserved.
            </div>
